 ...
 *
 * [DESCRIPTION]:  Header file for the interface for the AFIO functions. 
 *                 Contains #defines & prototypes.
 ************************************************************************************************/
...
/**
 * @brief Sets up the external interrupt configuration on the specified EXTI line
 * - EXTI_Line & PortMap are masked with 0x0F to avoid any misconfigurations
 * @param EXTI_Line External Interrupt line
 * @param PortMap   Port bits to map the interrupt to
 */
void AFIO_setEXTIConfiguration(u8 EXTI_Line, u8 PortMap);

/**
 * @brief Enables the clock for the AFIO peripheral.
 *
 */
